                ...
                <div class="row">
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Industrial licences</h6>
                        </div>
                        <div class="card-body">
                            @if(count($licences) == 0)
                                                ...
                                                <tr scope="row">
                                                    ...
                                                    <td>
                                                        <a href="#" class="img" data-toggle="modal" data-target="#myModal" >
                                                            ...
                                                            <img height="0" width="0" id="{{$licence->id}}" src="{{asset('/inlicence/'.$licence->image)}}" />

                                                        </a>
                                                    </td>
                                                    <td>
                                                        <form id="{{$licence->id}}" action="/inapprove" method="POST">
                                                    ...
                                                    <td>
                                                        <form id="{{$licence->id. '_' . $licence->id}}" action="/indecline" method="POST">
                                                            <input type="hidden" name="id" value="{{$licence->id}}" >
                                                            @csrf

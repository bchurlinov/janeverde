            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            @if(count($licences) == 0)
                                <p>No pending supporting documents for verification</p>
                            @else
                                <div class="card shadow mb-4">
                                    <div class="card-body">
                                        <table class="table table-striped" style="width:100%" id="active">
                                            ...
                                            @foreach($licences as $id => $licence)
                                                <tr scope="row">
                                                    ...
                                                    <td>
                                                        <form id="{{$licence->id}}" action="/sdapprove" method="POST">
                                                    ...
                                                    <td>
                                                        <form id="{{$licence->id. '_' . $licence->id}}" action="/sddecline" method="POST">
                                                            <input type="hidden" name="id" value="{{$licence->id}}" >
                                                            @csrf
